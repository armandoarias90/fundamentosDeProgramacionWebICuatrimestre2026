...
function validation_alert(ptext) {
    swal.fire({
        ...
        confirmButtonColor: "#f26292",
        html: '<iframe width="360" height="240" src="https://lottie.host/embed/c2382b1a-1066-4171-8f7a-e06a10afc775/PdUP6jtgfJ.json" frameborder="0"></iframe><br><p>' + ptext + " </p>", 
    });
}
        ...
        */
        if (user_input == username && pass_input == password) {
            Swal.fire({
                ...
                timer: 5000,
                html: '<iframe width="360" height="240" src="https://lottie.host/embed/8b9b4ec0-5ea9-4490-bbe9-ff9be7a73c4e/jnJNa90Z7b.json" frameborder="0"></iframe><br><br><p>Esperar un momento...</p>',                
            }).then(() => {
